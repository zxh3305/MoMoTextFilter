...
This plugin supports a wide range of detecting methods, including chat messages, anvil renamings, sign texts, writable book texts, PlayerChat messages, CMI messages, and [ServerShout](https://modrinth.com/plugin/servershout-momo) messages (Velocity version only).
...
本插件支持多种文本检测方式 包括聊天消息、铁砧命名、告示牌文本、书与笔文本、PlayerChat 文本、CMI 文本以及 [ServerShout](https://modrinth.com/plugin/servershout-momo) 文本（仅限 Velocity 版本）
